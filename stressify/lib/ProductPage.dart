...
_launchURLBrowser() async {
  const url = 'https://youtu.be/wNlVwQsDo44';
...
_launchURLApp() async {
  const url = 'https://images.squarespace-cdn.com/content/v1/567c08ae57eb8dca48ecdfa2/1508247456090-LD8T2RCY7AAEJZ3HRNY4/Benefits+of+Meditation?format=1000w';
  if (await canLaunch(url)) {
...
_launchURLApp1() async {
  const url = 'https://youtu.be/iplZGpP2VO0';
  if (await canLaunch(url)) {
    await launch(url, forceSafariVC: true, forceWebView: true);
  } else {
    throw 'Could not launch $url';
